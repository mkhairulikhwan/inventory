...
<head>
    ...
    <title>MTs Darul Istiqamah HST | Keluar</title>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <form method="post">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <div class="modal-body">
                                                                        Apakah Anda yakin ingin menghapus barang ini dari Barang Keluar?
                                                                        <br>
                                                                        *Barang Masuk akan bertambah
                                                                        <input type="hidden" name="id" value="<?= $id; ?>">
                                                                        <input type="hidden" name="idx" value="<?= $idb; ?>">
                                                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="barang_keluar_act.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Kondisi</label>
                            <input name="ket" type="text" class="form-control" placeholder="Kondisi">
                        </div>
