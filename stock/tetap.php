...
if (isset($_POST['updateorder'])) {
    ...
    $updatedataorder = mysqli_query($conn, "update sbrg_order set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran', satuan='$satuan', keterangan='$keterangan' where idx='$idx'");
    ...
    if ($updatedataorder) {
        ...
        echo " <div class='alert alert-success'>
            ...
            <meta http-equiv='refresh' content='1; url= tetap.php'/>  ";
    } else {
...
if (isset($_POST['hapus'])) {
    ...
    $delete = mysqli_query($conn, "delete from sbrg_order where idx='$idx'");
...
<head>
    ...
    <title>MTs Darul Istiqamah HST | Tetap</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <h2>Barang Tetap</h2>
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah barang tetap</button>
                                </div>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $brgs = mysqli_query($conn, "SELECT * from sbrg_order order by nama ASC");
                                            $no = 1;
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Barang Tetap Edit: <?php echo $p['nama'] ?> - <?php echo $p['jenis'] ?> - <?php echo $p['ukuran'] ?></h4>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Barang Tetap <?php echo $p['nama'] ?> - <?php echo $p['jenis'] ?> - <?php echo $p['ukuran'] ?></h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>

                                                                <!-- Modal body -->
                                                                <div class="modal-body">
                                                                    Apakah Anda yakin ingin menghapus data ini dari Barang Tetaps?
                                                                    <input type="hidden" name="idbrg" value="<?= $idb; ?>">
                                                                </div>
                                ...
                                <a href="exportorder.php" target="_blank" class="btn btn-info">Export Data</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="barang_order_act.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="jenis" type="text" class="form-control" placeholder="Barang">
                        </div>
                        <div class="form-group">
                            <label>Merk</label>
                        ...
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input name="stock" type="number" min="0" class="form-control" placeholder="Jumlah">
                        </div>
                        <div class="form-group">
                            <label>Satuan</label>
