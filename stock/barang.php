...
<head>
    ...
    <title>MTs Darul Istiqamah HST | Barang</title>
...
<body>
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <label for="jenis">ID Perangkat</label>
                                                                    ...
                                                                    <label for="lokasi">Kondisi</label>
    ...
    <div id="myModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Masukkan Barang manual</h4>
                </div>
                <div class="modal-body">
                    <form action="tmb_brg_act.php" method="post">
                        ...
                        <div class="form-group">
                            <label>Kondisi</label>
                            <input name="lokasi" type="text" class="form-control" placeholder="Kondisi barang">
                        </div>
